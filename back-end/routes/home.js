...
routerHome.post(
  ...
  controllerHome.deleteDeliveryAddress
);
...
routerHome.post(
  ...
  controllerHome.editUserManagement
);
...
routerHome.post(
  "/newcategory",
  authMiddleware.isAuthAdmin,
  controllerHome.addCategory
);
routerHome.post(
  "/editcategory",
  authMiddleware.isAuthAdmin,
  controllerHome.editCategory
);
routerHome.post(
  "/deletecategory",
  authMiddleware.isAuthAdmin,
  controllerHome.deleteCategory
);
